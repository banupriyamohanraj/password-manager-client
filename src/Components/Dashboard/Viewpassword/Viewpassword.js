...
function Viewpassword() {
  ...
  useEffect(() => {
    let Viewpassword = async (e) => {
      await fetch(
        `https://password-manager-repo.vercel.app/vault/${userdata.userlist.user._id}`,
        {
          method: "GET",
          headers: {
  ...
  let EditButtonAction = async (item) => {
    await fetch(
      `https://password-manager-repo.vercel.app/vault/update/${userdata.userlist.user._id}/${item.username}`,
      {
        method: "PUT",
        body: JSON.stringify({
  ...
  let DeleteButtonAction = async (item) => {
    await fetch(
      `https://password-manager-repo.vercel.app/vault/delete/${userdata.userlist.user._id}/${item.username}`,
      {
        method: "DELETE",
        headers: {
          "content-type": "application/json",
